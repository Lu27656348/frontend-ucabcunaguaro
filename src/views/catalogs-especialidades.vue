      ...
      <div class="committe__container__preview">
        ...
        <form action="" class="committe__container__preview__form">
          <div class="request__container__preview__form up-de">
            <p>Nombre de Especialidad</p>
            <input type="text" v-model="especialidad.nombre_especialidad">
            <p>Area de la Especialidad</p>
            <input type="text" v-model="especialidad.nombre_area">
            <div class="actions">
              <button 
